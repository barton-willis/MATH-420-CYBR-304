...
\begin{align*}
    \fl(1/10)  &= \left(1+1/2 + 1/16 + 1/32 + 1/256 + 1/512 \right) \times \frac{1}{16},\\
                  &=  \frac{819}{8192}, \\
                  &\approx 0.0999755859375.
\end{align*}
\end{solution}
...
\begin{align*}
    \left[ \left |\fl(1/10)  - 1/10| \leq  \frac{1}{2048}  \right | \right] &\equiv \left[ \left | \frac{819}{8192}  - \frac{1}{10} \right |  \leq  \frac{1}{2048} \right], 
    \\
    &\equiv  \left[ \frac{1}{40960} \leq \frac{1}{2048} \right], \\
       &\equiv \text{True}.
\end{align*} 
